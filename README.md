...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/uassist-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12434&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/uassist-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `uassist` can be installed with:

```
conda install uassist
```

It is possible to list all of the versions of `uassist` available on your platform with:
